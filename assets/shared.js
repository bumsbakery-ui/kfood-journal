(() => {
  ...
  if (footer) footer.innerHTML = `<footer class="site-footer route-footer"><a class="wordmark" href="${prefix}/">KFOOD <em>Journal</em></a><p>© 2026 KFOOD Journal. Korean flavors, globally shared.</p><div><a href="${prefix}/about/">${labels.about}</a><a href="${prefix}/contact/">${labels.contact}</a><a href="${prefix}/privacy/">${labels.privacy}</a></div></footer>`;
